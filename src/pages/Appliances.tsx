...
export default function Appliances() {
    ...
    const filteredProducts:any = Products.filter((p:any) => p.category == "appliances")
    return(
        <div className="container w-full">
            <h3 className="text-3xl font-semibold max-sm:text-center mt-10">Appliances Products</h3>
