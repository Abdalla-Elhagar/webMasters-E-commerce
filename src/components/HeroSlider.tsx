...
export default function HeroSlider() {
    return (
        <div className='col-span-4 p-16 pt-14 max-xl:px-8 max-xl:pr-0 max-sm:pt-0 z-10 max-lg:p-0  max-sm:px-0 max-lg:col-span-1'>
            ...
            className="mySwiper">
                ...
                <div className="left text-white flex flex-col gap-7 justify-between">
                    ...
                    <a className="ml-2 text-xl border-b-2 border-white mr-5 pb-2" href="#">Shop Now</a>
                    <EastIcon />
                    </div>

                </div>
                <div className="right"><img className="w-[496px]" src={iphone} /></div>
